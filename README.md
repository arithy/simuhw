...
1. Create instances of the derived classes of [`Device`](https://arithy.github.io/simuhw/apidoc/simuhw.html#simuhw.Device) class. As of version 0.3.0, the following device classes are available.
    ...
    - Floating-Point Arithmetic
      ...
      - [`float.FPNegator`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPNegator)
      - [`float.FPAdder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPAdder)
      - [`float.FPSubtractor`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPSubtractor)
      - [`float.FPMultiplier`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPMultiplier)
      - [`float.FPFusedMultiplyAdder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPFusedMultiplyAdder)
      - [`float.FPDivider`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPDivider)
      - [`float.FPRemainder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPRemainder)
      - [`float.FPSquareRoot`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPSquareRoot)
      - [`float.FPComparator`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPComparator)
      - [`float.FPClassifier`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPClassifier)
      - [`float.FPToIntegerRounder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPToIntegerRounder)
      - [`float.FPToIntegerConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPToIntegerConverter)
      - [`float.FPToSignedIntegerConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPToSignedIntegerConverter)
      - [`float.FPFromIntegerRounder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPFromIntegerRounder)
      - [`float.FPFromSignedIntegerConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPFromSignedIntegerConverter)
      - [`float.FPConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.FPConverter)
      - [`float.SIMD_FPNegator`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPNegator)
      - [`float.SIMD_FPAdder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPAdder)
      - [`float.SIMD_FPSubtractor`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPSubtractor)
      - [`float.SIMD_FPMultiplier`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPMultiplier)
      - [`float.SIMD_FPFusedMultiplyAdder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPFusedMultiplyAdder)
      - [`float.SIMD_FPDivider`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPDivider)
      - [`float.SIMD_FPRemainder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPRemainder)
      - [`float.SIMD_FPSquareRoot`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPSquareRoot)
      - [`float.SIMD_FPComparator`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPComparator)
      - [`float.SIMD_FPClassifier`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPClassifier)
      - [`float.SIMD_FPToIntegerRounder`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPToIntegerRounder)
      - [`float.SIMD_FPToIntegerConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPToIntegerConverter)
      - [`float.SIMD_FPToSignedIntegerConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPToSignedIntegerConverter)
      - [`float.SIMD_FPFromIntegerConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPFromIntegerConverter)
      - [`float.SIMD_FPFromSignedIntegerConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPFromSignedIntegerConverter)
      - [`float.SIMD_FPConverter`](https://arithy.github.io/simuhw/apidoc/simuhw.float.html#simuhw.float.SIMD_FPConverter)
      - [`float.riscv.FRec7`](https://arithy.github.io/simuhw/apidoc/simuhw.float.riscv.html#simuhw.float.riscv.FRec7)
      - [`float.riscv.FRSqrt7`](https://arithy.github.io/simuhw/apidoc/simuhw.float.riscv.html#simuhw.float.riscv.FRSqrt7)
      - [`float.riscv.SIMD_FRec7`](https://arithy.github.io/simuhw/apidoc/simuhw.float.riscv.html#simuhw.float.riscv.SIMD_FRec7)
      - [`float.riscv.SIMD_FRSqrt7`](https://arithy.github.io/simuhw/apidoc/simuhw.float.riscv.html#simuhw.float.riscv.SIMD_FRSqrt7)
    - Memory
